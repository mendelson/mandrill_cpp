 ...
 * implementação de um subscriber/observer e, portanto, deve ser herdada por
 * classes que desempenham o papel de observers.
 *
 */
class Observer
{
public:
	 ...
	 *
	 * Caso seja necessário realizar alguma operação na destruição do objeto,
	 * este método pode ser sobrescrito pela classe filha.
	 *
	 */
	virtual ~Observer() {}

	/*! \brief Método invocado para que o objeto seja notificado sobre a
	 * ocorrência de um evento que lhe é de interesse.
	 *
	 ...
	 *
	 * \param subject Referência para o objeto publisher, ou seja, objeto que
	 * irá notificar este objeto aqui sobre a ocorrência de eventos de
	 * interesse.
	 * \param id Número de identificação do objeto, definido pela política
	 * interna do objeto publisher.
	 */
